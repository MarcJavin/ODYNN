...
def inhibit():
    inhib = opthh.circuit.SYNAPSE_inhib
    connections = {(0,1) : inhib, (1,0) : inhib}
    t = np.array(sp.arange(0.0, 2000., opthh.datas.DT))
...
def opt_neurons():
    connections = {(0, 1): opthh.circuit.SYNAPSE_inhib,
                   (1, 0): opthh.circuit.SYNAPSE}
    t = np.array(sp.arange(0.0, 1000., opthh.datas.DT))
...
def full4to1():
    ...
    conns = {(0, 4): opthh.circuit.SYNAPSE,
             ...
             (3, 4): opthh.circuit.SYNAPSE,
             }
    conns_opt = {(0, 4): opthh.circuit.get_syn_rand(),
             (1, 4): opthh.circuit.get_syn_rand(),
             (2, 4): opthh.circuit.get_syn_rand(),
             (3, 4): opthh.circuit.get_syn_rand(),
             }
    dir = '4to1-test'
...
def full441():
    t, i = opthh.datas.full4(nb_neuron_zero=6)
    print(i.shape)
    n_neuron = 10
    conns = {(0, 4): opthh.circuit.SYNAPSE,
             (1, 4): opthh.circuit.SYNAPSE,
             (2, 4): opthh.circuit.SYNAPSE,
             (3, 4): opthh.circuit.SYNAPSE,
             (0, 5): opthh.circuit.SYNAPSE1,
             (1, 5): opthh.circuit.SYNAPSE1,
             (2, 5): opthh.circuit.SYNAPSE1,
             (3, 5): opthh.circuit.SYNAPSE1,
             (0, 6): opthh.circuit.SYNAPSE2,
             (1, 6): opthh.circuit.SYNAPSE2,
             (2, 6): opthh.circuit.SYNAPSE2,
             (3, 6): opthh.circuit.SYNAPSE2,
             (0, 7): opthh.circuit.SYNAPSE,
             (1, 7): opthh.circuit.SYNAPSE1,
             (2, 7): opthh.circuit.SYNAPSE,
             (3, 7): opthh.circuit.SYNAPSE1,
             (4, 8): opthh.circuit.SYNAPSE1,
             (5, 8): opthh.circuit.SYNAPSE,
             (6, 8): opthh.circuit.SYNAPSE,
             (7, 8): opthh.circuit.SYNAPSE2,
             (4, 9): opthh.circuit.SYNAPSE,
             (5, 9): opthh.circuit.SYNAPSE2,
             (6, 9): opthh.circuit.SYNAPSE1,
             (7, 9): opthh.circuit.SYNAPSE,
             }
    conns_opt = dict([(k, opthh.circuit.get_syn_rand()) for k in conns.keys()])
    dir = '4to4to2-test'
...
if __name__ == '__main__':
    ...
    if(xp == '21exc'):
        n_neuron = 2
        conns = {(0,1) : opthh.circuit.SYNAPSE}
        conns_opt = {(0,1) : opthh.circuit.get_syn_rand(True)}
        dir = '2n-1exc-test'
    elif(xp=='21inh'):
        n_neuron = 2
        ...
        conns = {(0,1): opthh.circuit.SYNAPSE,
                 (1,0): opthh.circuit.SYNAPSE}
        conns_opt = [{(0,1): opthh.circuit.get_syn_rand(True),
                      (1,0): opthh.circuit.get_syn_rand(True)} for _ in range(100)]
        dir = '2n-2exc-test'
    elif(xp == '21exc1inh'):
        n_neuron = 2
        conns = {(0, 1): opthh.circuit.SYNAPSE,
        ...
        conns_opt = {(0, 1): opthh.circuit.get_syn_rand(False),
                     (1, 0): opthh.circuit.get_syn_rand(False)}
        dir = '2n-2inh-test'
    t, i = opthh.datas.give_train(dt=0.5)
